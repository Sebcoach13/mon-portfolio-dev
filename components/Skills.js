...
  return (
    // 🛑 CORRECTION 1: Suppression de bg-gray-50
...
            <div 
              key={index} 
              // 🛑 CORRECTION 2: Suppression de bg-white
              className="p-6 rounded-lg shadow-xl hover:shadow-2xl transition duration-300 transform hover:scale-[1.02] border-t-4 border-primary-600"
            >
...
                  <span 
                    key={tech} 
                    // 🛑 CORRECTION 3: Suppression du fond gris sur les tags pour qu'ils héritent du gris clair
                    className="px-3 py-1 text-sm font-medium text-gray-800 rounded-full"
                  >
                    {tech}
                  </span>
                ))}
